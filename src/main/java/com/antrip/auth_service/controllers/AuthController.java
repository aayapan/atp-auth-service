...
public class AuthController {
    ...
    @GetMapping("/validate")
    public ResponseEntity<Void> validateToken(@RequestHeader("Authorization") String token, @RequestHeader("username") String username) {
        authService.validateToken(token.substring(7), username);
